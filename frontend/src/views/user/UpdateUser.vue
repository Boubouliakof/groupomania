<template>
  <div>
    ...
    <b-form @submit.prevent="editUser" enctype="multipart/form-data">
      ...
      <b-form-group id="input-group-2" label="Votre prénom :" label-for="input-firstname">
      ...
      <b-form-group id="input-group-2" label="Votre service :" label-for="input-service">
        <b-form-input id="input-service" type="text" placeholder="Entrer votre prenom" required v-model="user.service" ></b-form-input>
      </b-form-group>
